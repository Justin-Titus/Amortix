      ...
      <aside className="space-y-4 xl:sticky xl:top-24 xl:h-fit">
        <div className="glass-panel space-y-4 p-5">
          ...
          <div>
            ...
            <SkeletonLine className="mt-1 h-4 w-5/6" />
          </div>
        ...
        <div className="card space-y-3">
          ...
          <div className="space-y-2">
            {[1, 2, 3].map((i) => (
               <SkeletonBlock key={i} className="h-14 w-full rounded-card" />
            ))}
          </div>
        </div>
      </aside>
      ...
      <div className="flex flex-col h-[600px] md:h-[calc(100vh-140px)] rounded-2xl border border-amortix-border-light bg-white overflow-hidden">
        <div className="flex flex-col flex-1 p-4 space-y-6">
           <div className="flex items-start gap-3 w-3/4">
             <SkeletonBlock className="flex-shrink-0 h-8 w-8 rounded-lg" />
           ...
           <div className="flex items-start gap-3 w-2/3 self-end flex-row-reverse">
             ...
             <SkeletonBlock className="h-16 w-full rounded-2xl rounded-tr-sm bg-amortix-emerald/10" />
           </div>
        ...
        <div className="border-t border-slate-100 p-4 bg-white">
          <div className="w-full flex items-center gap-3">
             ...
             <SkeletonBlock className="h-12 w-12 rounded-[var(--radius-button)]" />
          </div>
        </div>
      </div>
      </div>
