export default function Loading() {
  return (
    <div className="mx-auto w-full max-w-105 animate-fade-up space-y-5" role="status" aria-live="polite" aria-busy="true" aria-label="Loading forgot password form">
      ...
      <div className="card space-y-4" aria-hidden="true">
        ...
        <div className="mx-auto h-4 w-28 animate-pulse rounded-lg bg-slate-100" />
      </div>
    </div>
  );
}
